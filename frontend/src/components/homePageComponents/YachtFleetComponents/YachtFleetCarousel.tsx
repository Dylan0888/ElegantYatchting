...
const YachtFleetCarousel = () => {
  ...
  const yachtCarouselLayout: yachtCarouselLayout = [
    [yachtList[0].image, yachtList[1].image, yachtList[2].image], // slide 1
    [yachtList[3].image, yachtList[4].image, yachtList[5].image], // slide 2
    [yachtList[6].image, yachtList[7].image, yachtList[8].image], // slide 3
  ]
